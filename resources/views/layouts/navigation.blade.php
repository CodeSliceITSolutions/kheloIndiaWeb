    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin-draw-lucky3')" :active="request()->routeIs('admin-draw-lucky3')">
                        {{ __('Lucky 3') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin-draw-lucky3-plus')" :active="request()->routeIs('admin-draw-lucky3-plus')">
                        {{ __('Lucky 3 Plus') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin-draw-max3-plus')" :active="request()->routeIs('admin-draw-max3-plus')">
                        {{ __('Max 3 Plus') }}
                    </x-nav-link>
                </div>
            </div>
